<form class="contactForm" id="contactForm" action="contactFormProcess.php" method="post">
  ...
  <div class = "contactFormInputs">
    <div class = "contactEmailContainer">
      <p id="emailValidationMsg" style="<?= $msgAttempt && !isset($_SESSION['email']) ? "visibility: visible;" : "" ?>">Email entered is not valid</p>
      <input type="email" id="email" name="email" maxlength="64" style="<?= $msgAttempt && !isset($_SESSION['email']) ? "border-color: #ff0000; box-shadow: 0 0 10px #ff0000;" : "" ?>" value = "<?= isset($_SESSION['email']) ? $_SESSION['email'] : "" ?>" placeholder="Email Address" required>
    </div>
